<template>
	<div id="prison" class="bg-primary" :class="mode">
		...
		>
			...
			<ul
				id="buttonsBottom"
				class="absolute bottom-0 right-0 z-50 m-0 p-0"
			>
				<li class="block">
					<a
						id="whatsapp"
					...
					>
						...
						>
							<title>
								Ota rohkeasti yhteyttä ja keskustellaan miten
								voisimme auttaa
							</title>
							<path
			...
			<nav class="pr-14" :class="{ active: active, hidden: !active }">
