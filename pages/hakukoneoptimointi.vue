	...
	<div class="container mx-auto py-10 font-serif">
		<div class="grid grid-cols-2 gap-6">
			<div class="m-auto">
				<img
					class="rounded-3xl"
					src="https://tuspe.com/images/websites-page.webp"
				/>
			</div>
			...
			<div class="m-auto">
				...
				<button
					...
					@click="goToYllapito()"
				>
					Hakukoneita viettelemään!
				</button>
			</div>
		</div>

		<div class="grid grid-cols-1 gap-6 m-auto mx-15 px-20 text-left">
			<h2 class="text-3xl text-blue-900 mt-20 text-center">
			...
			<p class="mt-1">
				...
				osalta. Hakukoneoptimointi on kustannustehokasta, sillä hyvin
				optimoitu sivusto löytyy hakukoneista oikeilla hakusanoilla
				riittävän korkealta orgaanisesti ja se saa myös maksetussa
			...
			<p class="mt-1">
				...
				suunnitteluvaiheessa. Avainsanatutkimuksella selvitetään, miten
				paljon hakuja tehdään tietyillä sanoilla yrityksesi toimialalla
				ja tuotteisiin tai palveluihin liittyen. Kun volyymiltaan
				suurimmat avainsanat on selvitetty, upotetaan ne kotisivujesi
				tai verkkokauppasi sisältöteksteihin. Näin mahdollistetaan
				kotisivujesi sekä sen alasivujen löytyminen potentiaalisille
				asiakkaillesi.
			</p>
			<p class="mt-1">
				Vaikka kotisivusi ja verkkokauppasi olisivat visuaalisesti ja
				rakenteeltaan upeat ja lyömättömät, eivät asiakkaasi välttämättä
				löydä sivuja, jollei niitä ole hakukoneoptimoitu.
			</p>
			<p class="mt-1">
				Onko sinulla jo valmiit kotisivut tai verkkokauppa, joiden
				sisältöä olisi syytä tarkistaa? Kysy kattavaa analyysia sivujesi
				nykyisestä tilanteesta. Tarkistetaan, ovatko sivusi
				hakukoneoptimoidut ja miten sivujen tehokkuutta voisi parantaa.
				Saat myös tekniset parannukset jo olemassa olevaan sivustoon.
			</p>
		</div>
	</div>
</template>
...
<script>
	export default {
		...
		head() {
			return {
				title: "Hakukoneoptimointi (SEO) | Tuspe Design",
				meta: [
					{
						property: "og:title",
						name: "twitter:title",
					...
					},
					{
						...
						type: "image/jpg",
						size: "720x900",
						content: "https://tuspe.com/images/websites-page.jpg",
					},
				],
			};
		},
