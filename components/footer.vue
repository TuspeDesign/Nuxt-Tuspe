<template>
	<footer class="text-center mt-5">
		<a
			class="fixed right-1 bottom-1 z-50"
			id="whatsapp"
			...
			>
				<title>
					Ota rohkeasti yhteyttä ja keskustellaan miten voisimme
					auttaa
				</title>
				<path
		...
		<div class="py-5">
			...
			<div class="flex justify-center mt-2">
				<a
					class="px-1 transform hover:scale-110 duration-300"
				...
				<a
					class="px-1 transform hover:scale-110 duration-300"
					href="https://twitter.com/tuspedesign"
					title="Tuspe Design on Twitter"
					rel="noopener me"
					target="_blank"
				>
					<div class="cell">
				...
				<a
					...
					title="Timo Anttila on LinkedIn"
					rel="noopener me"
					target="_blank"
				>
					<div class="cell">
